...
export default function Great_League() {

    const [data, setData] = useState([]);
    const [query, setQuery] = useState("");

    useEffect(() =>{
        let value = Great_League_Data();
        setData(value);
    },[]);
    ...
    <div className='relative z-10 h-screen'  >
        ...
        <div className="flex flex-col px-3 py-3 gap-8 h-full lg:h-5/6">
            ...
            <div className="flex items-center ">
                <Link to="/BattleDex/Ranking/Great_league" className='flex justify-center' ><img src={greatball} alt="UltraBall pokeball" className="min-w-0  w-4/5 md:w-2/5 lg:w-2/5 brightness-150 drop-shadow-great " /></Link>
                <Link to="/BattleDex/Ranking/Ultra_league" className='flex justify-center' ><img src={ultraball} alt="GreatBall pokeball" className="min-w-0 w-3/5 md:w-1/3 b lg:w-1/3  brightness-50 hover:brightness-75 hover:drop-shadow-ultra" /></Link>
