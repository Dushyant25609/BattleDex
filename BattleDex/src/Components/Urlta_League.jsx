                ...
                <div className="flex items-center">
                    <Link to="/BattleDex/Ranking/Great_league" className='flex justify-center'>
                        <motion.img
                            ...
                            className="min-w-0 w-3/5 md:w-1/3 b lg:w-1/3 brightness-50 hover:brightness-75 hover:drop-shadow-great"
                        />
                    </Link>
                    <Link to="/BattleDex/Ranking/Ultra_league" className='flex justify-center'>
                        <motion.img
                            ...
                            className="min-w-0 w-4/5 md:w-2/5 lg:w-2/5 brightness-150 drop-shadow-ultra"
                        />
                    </Link>
                    <Link to="/BattleDex/Ranking/Master_league" className='flex justify-center'>
                        <motion.img
                            ...
                            className="min-w-0 w-3/5 md:w-1/3 lg:w-1/3 brightness-50 hover:brightness-75 hover:drop-shadow-master"
                        />
                    </Link>
                </div>
                <motion.div
